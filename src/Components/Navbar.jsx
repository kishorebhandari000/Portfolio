...
function Navbar(){
  return(
<nav className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white  px-6">
  <div className="mx-auto flex items-center  justify-between">
    ...
    <div className="flex gap-6">
      <Link to="/" className="flex items-center gap-1 hover:text-gray-300"><HiHome/>Ghar</Link>
    ...
    <button className="bg-white text-indigo-600 px-4 py-2 rounded-lg font-semibold hover:bg-gray-200 transition duration-300">
           My Projects
          </button>
  </div>
</nav>
