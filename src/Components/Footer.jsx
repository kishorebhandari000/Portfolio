...
<div className="max-w-7xl mx-auto px-8 flex justify-end">
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 w-fit text-right ">
<div>
  <ul className="space-y-5 text-white text-lg">
<li><Link to="/Register">Register</Link></li>
<li><a href="#" className="hover:text-gray-400 transition duration-300">Sign in</a></li>
<li><a href="#"  className="hover:text-gray-400 transition duration-300">Contact Me</a></li>
</ul>
</div>
<div >
 <ul className="space-y-5 text-white text-lg">
